...
1. **Side Project:**
   ...
   2. Build the [3d Donut](https://www.a1k0n.net/2011/07/20/donut-math.html) in ruby and Clojure as I'm interested in the concepts and also how diffirent will it be to implement in functional as compared to OOP
2. **Introspection:**
...
*P.s. This blog was inspired by a friend's experiments. Go checkout [Gyani's](https://gyani.net/) blog for some inspiring content.*
